    ...
    return `
        <div class="calculator-form">
            <div class="calculator-description">
                ...
                <p>وديعة بنكية بمعدل فائدة ثابت لفترة محددة من 6 أشهر إلى سنتين. لا يمكن إضافة مبالغ شهرية.</p>
            </div>
...
function initializeEducationSection() {
    if (typeof financialEducationContent === 'undefined') return;
    ...
    educationCards.forEach(card => {
        card.addEventListener('click', function() {
            ...
            if (financialEducationContent[topic]) {
                showEducationalContent(financialEducationContent[topic]);
            }
        });
    });
}
...
function initializeInvestmentDashboard() {
    ...
    viewDetailsButtons.forEach(button => {
        button.addEventListener('click', function() {
            ...
            console.log('View details clicked for:', type);
...
// Show Investment Modal - New Implementation
function showInvestmentModal(type) {
    console.log('Showing investment modal for:', type);
    ...
    modal.innerHTML = createInvestmentModalContent(type);
...
// Create Investment Modal Content - New Implementation
function createInvestmentModalContent(type) {
    const data = getNewInvestmentData(type);
                            ...
                            <div class="investment-detail-card">
                                <div class="detail-header">
                                    <div class="detail-info">
                                        ...
                                        <span class="detail-symbol">${item.symbol}</span>
                                    </div>
                                    <div class="detail-price">
                                        <span class="current-price">${item.price}</span>
                                        <span class="price-change ${item.changeClass}">${item.change}</span>
                                    </div>
                                </div>
                                ...
                                <div class="detail-stats">
                                    ...
                                    <div class="stat-item">
                                        ...
                                        <span class="stat-value">${item.high}</span>
                                    </div>
                                    <div class="stat-item">
                                        <span class="stat-label">أقل سعر</span>
                                        <span class="stat-value">${item.low}</span>
                                    </div>
                                    <div class="stat-item">
                                        <span class="stat-label">القيمة السوقية</span>
                                        <span class="stat-value">${item.marketCap}</span>
                                    </div>
                                </div>
                            </div>
                        `).join('')}
...
// Get Investment Data - New Implementation
function getNewInvestmentData(type) {
    const data = {
        'crypto': {
